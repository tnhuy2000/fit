...
<?php $__env->startSection('content'); ?>
	<div class="card">
		<div class="card-header"><a href="<?php echo e(route('admin.home')); ?>">Trang chủ quản trị</a> <i class="fal fa-angle-double-right"></i> <a href="<?php echo e(route('admin.danhmuc.home')); ?>">Quản lý danh mục</a> <i class="fal fa-angle-double-right"></i> Danh sách đơn vị</div>
		<div class="card-body">
				...
				<tbody>
					<?php $__currentLoopData = $hrm_donvi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<tr>
							...
							<td><?php echo e($value->TenDonVi); ?></td>
							<td class="text-center"><a href="#sua" data-toggle="modal" data-target="#myModalEdit" onclick="getCapNhat(<?php echo e($value->ID); ?>, '<?php echo e($value->TenDonVi); ?>'); return false;"><i class="fal fa-edit"></i></a></td>
	...
	<form action="<?php echo e(route('admin.danhmuc.donvi.them')); ?>" method="post">
		<?php echo csrf_field(); ?>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="form-group">
							...
							<input type="text" class="form-control <?php $__errorArgs = ['TenDonVi'];
...
unset($__errorArgs, $__bag); ?>" id="TenDonVi" name="TenDonVi" value="<?php echo e(old('TenDonVi')); ?>" required />
...
unset($__errorArgs, $__bag); ?>
	...
	<form action="<?php echo e(route('admin.danhmuc.donvi.sua')); ?>" method="post">
		<?php echo csrf_field(); ?>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="form-group">
							...
							<input type="text" class="form-control <?php $__errorArgs = ['TenDonVi_edit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="TenDonVi_edit" name="TenDonVi_edit" value="<?php echo e(old('TenDonVi_edit')); ?>" required />
							<?php $__errorArgs = ['TenDonVi_edit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
	...
	<form action="<?php echo e(route('admin.danhmuc.donvi.xoa')); ?>" method="post">
		<?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\wamp64\www\fit\resources\views/admin/danhmuc/donvi.blade.php ENDPATH**/ ?>