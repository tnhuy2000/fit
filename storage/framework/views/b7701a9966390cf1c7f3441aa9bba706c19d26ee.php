...
<?php $__env->startSection('content'); ?>
	<div class="card">
		<div class="card-header"><a href="<?php echo e(route('admin.home')); ?>">Trang chủ quản trị</a> <i class="fal fa-angle-double-right"></i> <a href="<?php echo e(route('admin.hinhanh.danhsach')); ?>">Quản lý hình ảnh</a> <i class="fal fa-angle-double-right"></i> Sửa hình ảnh</div>
		<div class="card-body">
			<form role="form" method="post" action="<?php echo e(route('admin.hinhanh.sua', ['id' => $cms_hinhanh->ID])); ?>">
				<?php echo csrf_field(); ?>
				<input type="hidden" id="ID" name="ID" value="<?php echo e($cms_hinhanh->ID); ?>" />
...
unset($__errorArgs, $__bag); ?>" id="MaChuDe" name="MaChuDe" required>
						...
						<?php $__currentLoopData = $cms_chude; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<?php if($value->ID == $cms_hinhanh->MaChuDe): ?>
								<option value="<?php echo e($value->ID); ?>" selected><?php echo e($value->TenChuDe); ?></option>
							<?php else: ?>
...
unset($__errorArgs, $__bag); ?>" id="MoTa" name="MoTa" required><?php echo e($cms_hinhanh->MoTa); ?></textarea>
					<small class="form-text text-muted"><i class="fal fa-external-link-alt"></i> <span class="text-primary"><?php echo e($cms_hinhanh->MoTaKhongDau); ?></span></small>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\fit\resources\views/admin/hinhanh/sua.blade.php ENDPATH**/ ?>