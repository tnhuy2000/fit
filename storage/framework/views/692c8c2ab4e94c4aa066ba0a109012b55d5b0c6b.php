...
<head>
	...
	<title>503 - Bảo trì hệ thống - <?php echo e(config('app.name', 'LCMS')); ?></title>
	<link rel="shortcut icon" href="<?php echo e(asset('public/frontend/logo.png')); ?>" />
	...
	<link rel="stylesheet" href="<?php echo e(asset('public/frontend/css/color-variations/red.css')); ?>" media="screen" />
</head>
<body>
...
</html><?php /**PATH G:\wamp64\www\fit\resources\views/errors/503.blade.php ENDPATH**/ ?>