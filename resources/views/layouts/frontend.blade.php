	...
	<div class="body-inner">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8">
						...
						<div class="topbar-dropdown">
							@if(session()->has('enLanguage'))
								<div class="title"><a href="{{ route('language.vi') }}"><i class="fal fa-globe-americas"></i> Tiếng Việt</a></div>
							@else
								<div class="title"><a href="{{ route('language.en') }}"><i class="fal fa-globe-asia"></i> English</a></div>
							@endif
						</div>
					</div>
					<div class="col-md-4">
						<div class="social-icons social-icons-colored-hover">
							<ul>
								...
								<li class="social-rss"><a href="{{ route('rss') }}"><i class="fal fa-rss"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
								...
								<ul>
									<li class="dropdown">
										...
										<ul class="dropdown-menu">
											<li><a href="{{ url('/bai-viet/gioi-thieu/gioi-thieu-1.html') }}"><i class="fal fa-fw fa-globe-asia"></i>Giới thiệu</a></li>
											<li><a href="{{ route('sodotochuc') }}"><i class="fal fa-fw fa-sitemap"></i>Sơ đồ tổ chức</a></li>
											<li><a href="{{ route('nhansu') }}"><i class="fal fa-fw fa-users"></i>Nhân sự</a></li>
											<li><a href="{{ route('lienhe') }}"><i class="fal fa-fw fa-map-marked-alt"></i>Thông tin liên hệ</a></li>
										</ul>
									</li>
									<li class="dropdown">
										<a href="#tong-quan"><i class="fal fa-building"></i>Đơn vị trực thuộc</a>
										<ul class="dropdown-menu">
											<li><a href="{{ url('/bai-viet/gioi-thieu/ban-chu-nhiem-khoa-4.html') }}"><i class="fal fa-fw fa-cube"></i>Ban Chủ nhiệm Khoa</a></li>
											<li><a href="{{ url('/bai-viet/gioi-thieu/van-phong-khoa-5.html') }}"><i class="fal fa-fw fa-cube"></i>Văn phòng Khoa</a></li>
											<li><a href="{{ url('/bai-viet/gioi-thieu/bo-mon-cong-nghe-thong-tin-6.html') }}"><i class="fal fa-fw fa-cube"></i>Bộ môn Công nghệ thông tin</a></li>
											<li><a href="{{ url('/bai-viet/gioi-thieu/bo-mon-ky-thuat-phan-mem-7.html') }}"><i class="fal fa-fw fa-cube"></i>Bộ môn Kỹ thuật phần mềm</a></li>
										</ul>
									</li>
									<li class="dropdown">
										<a href="#tong-quan"><i class="fal fa-books"></i>Đào tạo</a>
										<ul class="dropdown-menu">
											<li><a href="{{ url('/bai-viet/gioi-thieu/dai-hoc-cong-nghe-thong-tin-10.html') }}"><i class="fal fa-fw fa-book"></i>Đại học Công nghệ thông tin</a></li>
											<li><a href="{{ url('/bai-viet/gioi-thieu/dai-hoc-ky-thuat-phan-mem-11.html') }}"><i class="fal fa-fw fa-book"></i>Đại học Kỹ thuật phần mềm</a></li>
											<li><a href="{{ url('/bai-viet/gioi-thieu/cao-dang-cong-nghe-thong-tin-12.html') }}"><i class="fal fa-fw fa-book"></i>Cao đẳng Công nghệ thông tin</a></li>
										</ul>
									</li>
									<li class="dropdown">
										<a href="{{ route('baiviet') }}"><i class="fal fa-bullhorn"></i>Thông báo</a>
										<ul class="dropdown-menu">
		...
		<footer id="footer">
			<div class="copyright-content">
				<div class="container">
					<div class="copyright-text text-center text-uppercase">&copy; {{ @date("Y") }} {{ config('app.name', 'LCMS') }}.</div>
				</div>
			</div>
		</footer>
	</div>
