...
@section('content')
	<div class="card">
		<div class="card-header"><a href="{{ route('admin.home') }}">Trang chủ quản trị</a> <i class="fal fa-angle-double-right"></i> <a href="{{ route('admin.hinhanh.danhsach') }}">Quản lý hình ảnh</a> <i class="fal fa-angle-double-right"></i> Đăng hình ảnh</div>
		<div class="card-body">
			<form role="form" method="post" action="{{ route('admin.hinhanh.them') }}">
				@csrf
